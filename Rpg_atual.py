...
def evento_setor7():
    ...
    time.sleep(3)
    print("Você entra na Porshe da gangue que te atacou, vasculha um pouco e acha algumas coisas.")
    time.sleep(2)
    print(f"{nome_player}: Esse carro era de um tal de V, acho que ja ouvi falar nesse nome.")
    time.sleep(3)
    ...
    time.sleep(3)
    print(f"{nome_player}: Achei que vocês só matavam esses cyberpsicóticos por aí. Eu tava só de passagem.")
    time.sleep(3)
    print("Equipe de exterminio: Bravo, aqui é Delta, alvo na mira.")
    time.sleep(3)
    print(f"{nome_player}: Melhor eu correr...")
    time.sleep(3)
